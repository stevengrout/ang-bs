...
.config(function($routeProvider, $locationProvider){
    ...
    $routeProvider.when('/', {
        ...
        templateUrl: '/ang-bs/Chapter 07/assets/partials/index.html'
    })

    .when('/add-contact', {
        controller: 'addCtrl',
        templateUrl: '/ang-bs/Chapter 07/assets/partials/add.html'
    })

    .when('/contact/:id', {
        controller: 'contactCtrl',
        templateUrl: '/ang-bs/Chapter 07/assets/partials/contact.html'
    })
...
.directive('editable', function(){
    return {
        restrict: 'AE',
        templateUrl: '/ang-bs/Chapter 07/assets/partials/editable.html',
        scope: {
            value: '=editable',
            field: '@fieldType'
        },
